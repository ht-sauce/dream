    ...
    >
      <div class="dingwei">
        ...
        <div class="right">
          ...
          <el-form-item label="居住地址" prop="provinceAndCity">
            <el-cascader
              :options="options"
              v-model="data.provinceAndCity"
              style="width: 400px;"
            >
            </el-cascader>
  ...
  methods: {
    ...
    createUserAjax() {
      let data = {
        ...
        provinceAndCity: this.data.provinceAndCity.toString(), //省市区域码
